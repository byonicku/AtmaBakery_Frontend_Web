    ...
    <Container>
      <Row className="mt-0 mt-md-3 mt-lg-0 mb-1 mb-lg-3 mb-md-3">
        <Col xl={5} lg={5} md={12} sm={12}>
          ...
          Margareth Alexandra Winata pemilik Atma Bakery adalah
          seorang visioner yang menggabungkan keahlian kuliner
          dengan dedikasi untuk menciptakan pengalaman berharga
          melalui rasa setiap produk kue-kuenya
          </div>
      ...
      <Row className="mt-3 mt-lg-2 mt-md-0 mb-0 mb-md-2">
        <Col xl={5} lg={5} md={12} sm={12}>
          <h1 style={{ 
            fontSize:"2rem",
            fontWeight: "bold"
           }} className="mt-0 mt-lg-3 mt-md-3 pt-0 pt-lg-4 pt-md-0">
            <span style={{ color: "#FF5B19" }}>Produk Pertama</span> Kali Hadir <br />
            Sejak<span style={{ color: "#FF5B19" }}> Hari Pertama</span> Atma <br/>
            Bakery Berdiri <span style={{ color: "#FF5B19" }}> Tahun 2022</span> 
          </h1>
          <div className="text-desc-own my-4">
            Sejak awal berdirinya tahun 2022 Atma Bakery telah menawarkan
            empat produk klasik yang menjadi ciri khasnya. Lapis Legit, Lapis 
            Surabaya, Spikoe, dan Mandarin telah menjadi pilihan utama sejak 
            hari pertama, mencerminkan dedikasi bakery dalam menciptakan 
            kue-kue berkualitas tinggi yang selalu memukau pelanggan.
          </div>
          <div className="text-desc-own my-4">    
            Lapis Legit memiliki tekstur lembut dan lapisan rempah yang kaya.
            Lapis Surabaya kombinasi kue cokelat dan kuning yang lembut. 
            Spikoe dengan konsistensi sempurna dan rasa lembut. 
            Mandarin, kue manis dengan sentuhan citrus segar. 
            Keempatnya mencerminkan kualitas tinggi dari Atma Bakery.
          </div>
        </Col>
        <Col xl={7} lg={7} md={12} sm={12} className="pt-0 pt-lg-0 pt-md-2">
      ...
      <Row className="mb-0 mb-lg-4 mb-md-3">
              ...
              <Card className="card-histori rounded-5">
                <Card.Body>
                  <Row className="d-flex justify-content-center">
                    ...
                    <Card.Text className="text-center card-font-histori">
                      Berikan perubahan teknologi pesan kue dimana saja, kapan saja
                    </Card.Text>
                  </Row>
                </Card.Body>
              </Card>
        ...
        <Col xl={6} lg={6} md={12} sm={12} className="ps-0 ps-lg-4 ps-md-4 pt-0 pt-lg-4 pt-md-5">
          <h1 style={{ 
            fontSize:"2rem",
            fontWeight: "bold",
            textAlign:"right"
           }} className="mt-0 mt-md-2 pt-0 pt-lg-3 pt-md-3">
            Rintisan <span style={{ color: "#FF5B19" }}>Atma Bakery</span><br />
            Mulai<span style={{ color: "#FF5B19" }}> Tahun Pendirian</span> Hingga<br/>
            Sekarang<span style={{ color: "#FF5B19" }}> Membawa Perubahan</span> 
          </h1>
          <div className="text-desc-own my-3" style={{ textAlign:"right" }}>
          ...
          sentuhan manis dengan memperluas koleksi kue, minuman, dan camilan pada 
          tahun 2024. Kini, Bakery ini tengah bersemangat merancang cabang baru untuk 
          memperluas kehadirannya di masa depan.
          </div>
        </Col>
      </Row>
      <Row>
        ...
        <Col xl={7} lg={7} md={12} sm={12}>
          ...
          <div className="text-desc-own my-2" style={{ textAlign:"left", marginBottom:"0" }}>
            Dari sentuhan tradisional hingga inovasi modern, toko kue kami adalah perjalanan rasa 
            yang melintasi masa, menghadirkan cita rasa yang timeless dalam setiap gigitannya.
          </div>
        </Col>
      </Row>
    </Container>
